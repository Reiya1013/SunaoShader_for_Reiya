			...
			using (new EditorGUILayout.VerticalScope("box"))
			{
				...
				using (new EditorGUILayout.VerticalScope("box"))
				{
					...
					if (DisolveEnable.floatValue == 1)
					{
						...
						ME.TexturePropertySingleLine(new GUIContent("Disolve Texture"), DisolveTex);
						ME.TextureScaleOffsetProperty(DisolveTex);
						ME.ShaderProperty(DisolveThreshold, new GUIContent("Disolve Threshold"));
						ME.TexturePropertySingleLine(new GUIContent("Disolve Emission Map"), DisolveEmissionMap);
				...
				using (new EditorGUILayout.VerticalScope("box"))
				{
					...
					if (Hidden.floatValue >= 0.5f)
					{
						...
						ME.TexturePropertySingleLine(new GUIContent("Emission Mask(HiddenMode)"), HiddenEmissionMap);
						ME.TextureScaleOffsetProperty(HiddenEmissionMap);
						ME.TexturePropertySingleLine(new GUIContent("Emission Mask2(HiddenMode)"), HiddenEmissionMap2);
