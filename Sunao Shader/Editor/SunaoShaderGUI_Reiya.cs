...
namespace SunaoShader_Apd_Reiya {
	...
	public class GUI : ShaderGUI {
		...
		MaterialProperty DisolveTex;
		MaterialProperty DisolveEmissionMap;
		MaterialProperty DisolveEmissionColor;
		MaterialProperty DisolveEmission;
		MaterialProperty DisolveThreshold;
		MaterialProperty Hidden;
		...
		public override void OnGUI(MaterialEditor ME , MaterialProperty[] Prop) {
			...
			DisolveTex = FindProperty("_DisolveTex", Prop, false);
			DisolveEmissionMap = FindProperty("_DisolveEmissionMap", Prop, false);
			DisolveEmissionColor = FindProperty("_DisolveEmissionColor", Prop, false);
			DisolveEmission = FindProperty("_DisolveEmission", Prop, false);
			DisolveThreshold = FindProperty("_DisolveThreshold", Prop, false);
			Hidden = FindProperty("_Hidden", Prop, false);
			HiddenMainTex = FindProperty("_HiddenMainTex", Prop, false);
			...
			GUILayout.Label("Add Option", EditorStyles.boldLabel);
			...
			using (new EditorGUILayout.VerticalScope("box"))
			{
				...
				using (new EditorGUILayout.VerticalScope("box"))
				{
					...
					GUILayout.Label("Disolve", EditorStyles.boldLabel);
					ME.ShaderProperty(DisolveEnable, new GUIContent("Enable Disolve"));

					if (DisolveEnable.floatValue == 1)
					{
						ME.ShaderProperty(TeleportEnable, new GUIContent("Teleport Mode"));
						ME.TexturePropertySingleLine(new GUIContent("Disolve Texture"), DisolveTex, Color);
						ME.TextureScaleOffsetProperty(DisolveTex);
						ME.ShaderProperty(DisolveThreshold, new GUIContent("Disolve Threshold"));
						ME.TexturePropertySingleLine(new GUIContent("Disolve Emission Map"), DisolveEmissionMap, Color);
						ME.TextureScaleOffsetProperty(DisolveEmissionMap);
						ME.ShaderProperty(DisolveEmissionColor, new GUIContent("Disolve Emission Color"));
						ME.ShaderProperty(DisolveEmission, new GUIContent("Disolve Emission"));
				...
				using (new EditorGUILayout.VerticalScope("box"))
				{
					...
					GUILayout.Label("Hidden Mode", EditorStyles.boldLabel);

					ME.ShaderProperty(Hidden, new GUIContent("Hidden Mode"));

					if (Hidden.floatValue >= 0.5f)
					{
						ME.TexturePropertySingleLine(new GUIContent("Main Texture(HiddenMode)"), HiddenMainTex, Color);
						ME.TextureScaleOffsetProperty(HiddenMainTex);
						ME.TexturePropertySingleLine(new GUIContent("Emission Mask(HiddenMode)"), HiddenEmissionMap, Color);
						ME.TextureScaleOffsetProperty(HiddenEmissionMap);
						ME.TexturePropertySingleLine(new GUIContent("Emission Mask2(HiddenMode)"), HiddenEmissionMap2, Color);
						ME.TextureScaleOffsetProperty(HiddenEmissionMap2);
					}
				}
			...
			GUILayout.Label("Sunao Shader(Add Reiya) " + Version_H + "." + Version_M + "." + Version_L , EditorStyles.boldLabel);
